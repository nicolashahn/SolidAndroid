...
import com.csform.android.uiapptemplate.adapter.BothListAdapter;
...
public class BothListFragment extends Fragment{
    ...
    private BothListAdapter adapter;
    ...
    public static BothListFragment newInstance(String url_) {
        BothListFragment fragment = new BothListFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new BothListAdapter(ctx, favorList, false, mListener, false);
